...
package starling.core
{
    ...
    public class Starling extends EventDispatcher
    {
        ...
        public function render():void
        {
            ...
            if (!mShareContext)
			{
				//Starling.dispatcher.dispatchEvent(new starling.events.Event("beforePresent"));
				
				stage.dispatchEvent(new starling.events.Event(starling.events.Event.READY_TO_RENDER));
