package TestBenches
{
	 ...
	 * @author Sushil Mandi
	 */
	public class TestBench_waveTxt extends Sprite 
	{
		...
		private var ptCon = new WavyText("The Jigsaw Puzzle", "Bernard MT Condensed", 60, [0XFFFFFF], 5, 1, !true);
		
		

		
		public function TestBench_waveTxt()
		{
			super();
