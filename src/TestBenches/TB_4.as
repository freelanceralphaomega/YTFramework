package TestBenches
{
	...
	import YTCore.Components.Animation.MovieClipSnapper;
	 ...
	 * @author Sushil Mandi
	 */
	public class TB_4 extends Sprite 
	{
		...
		private var office:Office = new Office();
		
		
		
		private var ptCon:MovieClipSnapper;
		
		

		
		public function TB_4()
		{
			super();
		...
		ptCon = new MovieClipSnapper(office, 530);
