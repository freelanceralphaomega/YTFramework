package YTCore.Derived.Circular 
{
	 ...
	 * @author ...
	 */
	public class CIRC_2 extends Sprite implements IRenderable 
	{
		private var canStep:Boolean = false;
		private var seq:Sequencer = new Sequencer();
		
		
		public function CIRC_2() 
		{
			super();
